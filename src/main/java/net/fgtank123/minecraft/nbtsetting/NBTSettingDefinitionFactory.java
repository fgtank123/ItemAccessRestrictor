...
public final class NBTSettingDefinitionFactory {
    @SafeVarargs
    public static <V extends Enum<V>> NBTSettingDefinitionEnumerable<V> createDefinedEnumerable(@Nonnull String name, @Nonnull Class<V> enumClass, V... possibleSettingValues) {
        V defaultValue = possibleSettingValues.length == 0 ? enumClass.getEnumConstants()[0] : possibleSettingValues[0];
        return new NBTSettingDefinitionEnumerable<>(
            name,
            defaultValue,
    ...
    @SafeVarargs
    public static <V> NBTSettingDefinitionEnumerable<V> createEnumerable(@Nonnull String name, @Nonnull Function<V, Tag> toTag, @Nonnull Function<Tag, V> fromTag, V... possibleSettingValues) {
    ...
    public static NBTSettingDefinitionEnumerable<Integer> createIntegers(@Nonnull String name, Integer... possibleSettingValues) {
    ...
    public static NBTSettingDefinitionEnumerable<Boolean> createBooleans(@Nonnull String name, boolean defaultSettingValue) {
        return new NBTSettingDefinitionEnumerable<>(
            name,
            defaultSettingValue,
            ByteTag::valueOf,
