...
import net.fgtank123.itemaccessrestrictor.core.gui.utils.ModTexture;
import net.fgtank123.itemaccessrestrictor.core.gui.utils.Rectangle;
import net.minecraft.client.gui.GuiGraphics;
import net.minecraft.resources.ResourceLocation;

import static net.fgtank123.itemaccessrestrictor.core.gui.ModTextureFiles.*;
